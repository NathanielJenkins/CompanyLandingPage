<template>
  <Nuxt>
    ...
    <section class="bg-white border-b text-gray-400 pt-8 pb-8">
      <div class="flex flex-col md:flex-row items-center justify-center space-x-0 md:space-x-12 mx-6">
        <div class="max-w-sm">
...
.form-button {
  @apply mx-auto lg:mx-0 hover:underline  text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg;
}
